"""
Inference script with wandb logging for MRC + BM25 Retrieval.

Usage:
    python -m src.inference.inference_bm25_wandb \
        --output_dir outputs/test_k100_wandb \
...
from ..retrieval.retrieval_bm25_wandb import BM25RetrievalWithMetrics
