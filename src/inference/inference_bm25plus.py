"""
Inference script with wandb logging for MRC + BM25Plus Retrieval.

Usage:
    python -m src.inference.inference_bm25plus \
        --output_dir outputs/test_k100_bm25plus \
        --dataset_name data/test_dataset \
        --model_name_or_path baseline/models/train_dataset \
        --do_predict \
        --top_k_retrieval 100 \
        --use_wandb \
        --wandb_project "mrc-retrieval" \
        --wandb_run_name "bm25plus_k100_test"
"""
...
def init_wandb(
    ...
    if run_name is None:
        run_name = f"bm25plus_k{data_args.top_k_retrieval}"
...
def run_sparse_retrieval(
    ...
    # BM25PlusRetrieval with metrics
    sparse_retriever = BM25PlusRetrieval(
