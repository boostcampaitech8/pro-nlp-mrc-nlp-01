...
def main():
    ...
    if data_args.dataset_name is not None:
        if os.path.exists(data_args.dataset_name) and os.path.isdir(data_args.dataset_name):
        ...
        if "validation" not in raw_datasets:
            if not (os.path.exists(data_args.dataset_name) and os.path.isdir(data_args.dataset_name)):
